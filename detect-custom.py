...
#tesseract model : https://github.com/anil2k/Car-number-plate-detection-YOLOv5-Tesseract/blob/main/yolov5/detect_custom.py
import numpy as np
import pytesseract
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    print(f"THe crop path is :{crop_file_path}")
